...
using amicables_collection =
    std::vector<std::pair<unsigned long, unsigned long>>;

inline unsigned long sum_proper_divisors(unsigned int const n) {
  unsigned long sum = 0;
...
inline amicables_collection calculate_amicables(unsigned long limit) {

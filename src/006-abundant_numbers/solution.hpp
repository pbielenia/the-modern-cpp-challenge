...
inline std::vector<unsigned int> get_proper_divisors(unsigned int const n)
{
...
inline long get_abundance(unsigned int const n, const unsigned long divisors_sum)
{
    return divisors_sum - n;
}

inline bool is_abundant_number(const unsigned int n, const unsigned long divisors_sum)
{
    return divisors_sum > n;
}

inline abundants_collection calculate_abundants(unsigned limit)
{
